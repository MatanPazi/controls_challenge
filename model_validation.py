...
fig, (ax1, ax2, ax3) = plt.subplots(3, 1, sharex=True) # sharex=True aligns the x-axes
...
ax2.plot(t, steer, label="Steer")
ax2.set_xlabel('Time (s)')
ax2.set_ylabel('Steer [rad?]')
ax2.set_title('Steer CMD')
ax2.legend()


# Plot data on the second (bottom) subplot
ax3.plot(t, ay_actual - ay_ref, label="Error")
ax3.set_xlabel('Time (s)')
ax3.set_ylabel('Lateral acceleration [m/s^2]')
ax3.set_title(f'Error - RMSE = {ctrl_rmse:.4f}')
ax3.legend()
